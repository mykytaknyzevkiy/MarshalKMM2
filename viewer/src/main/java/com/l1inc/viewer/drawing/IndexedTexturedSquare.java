...
public class IndexedTexturedSquare extends BaseDrawingObject {
    ...
    public IndexedTexturedSquare(int resId, Context context, float tiles, boolean loadTexture) {
        this.resId = resId;
        this.context = context;
        this.squareType = SquareType.SIMPLE;
        if (loadTexture) {
    ...
    private void loadTexture() {
        textureId = TextureCache.getTexture(context, resId, true, GLES20.GL_REPEAT);
    }
