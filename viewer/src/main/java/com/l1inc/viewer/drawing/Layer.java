...
public class Layer extends IDrawable {
    ...
    public Layer(final String layerName,
        ...
        for (int i = 0; i < shapeCount; i++) {
            LayerPolygon polygon = new LayerPolygon(baseShapeObject.getShapes().getShape().get(i), context, textureResId, extension, interpolation, isTextureCompressed, layerName, i);
    ...
    public boolean contains(final Vector point) {
        for (final LayerPolygon polygon : layerPolygons) {
