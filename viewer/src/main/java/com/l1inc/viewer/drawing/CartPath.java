...
/**
 * Created by Yevhen Paschenko on 4/25/2016.
 */
public class CartPath extends BaseDrawingObject {
    ...
    public CartPath(int resId, Context context, PointList pointList, double width) {
        ...
        startCap = new Cap(_pointList[0], width / 2);
