...
/**
 * Created by Kirill Kartukov on 02.04.2018.
 */
...
public class EarClippingTriangulator {
    ...
    public ShortArray computeTriangles (ArrayList<Float> verticesList) {
        float[] vertices = new float[verticesList.size()];
        return computeTriangles(vertices, 0, verticesList.size());
    }
