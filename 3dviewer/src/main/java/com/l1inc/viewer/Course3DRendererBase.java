...
public class Course3DRendererBase {
    ...
    protected ArrayList<CartDrawData> cartArray;
    ...
    public synchronized void setCartsArray(ArrayList<CartDrawData> cartArray) {
    ...
    public Location getOverridedPinPosition() {
        ...
        for (final PinPositionOverride override : pinPositionOverrides) {
            final DateTime todayStartOfDay = new DateTime().withMillisOfDay(0);
