...
public class Tile extends BaseDrawingObject {
    ...
    public boolean setTextureQuality(int quality, final int pos) {
    ...
    public static void releaseTexturesAndFrameBuffers() {
    ...
    public void initiateFrameBuffer(int pos) {
    ...
    public void prepareForRenderToTexture() {
    ...
    public boolean draw(Course3DRenderer renderer, int pos) {
